...
class OpacityIcon extends HTMLElement {
...
class LogOutIcon extends HTMLElement {
...
class ReloadButton extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.#btn.title = "Reload";
    this.#btn.id = 'reload-btn';
...
customElements.define("opacity-icon", OpacityIcon);
customElements.define("log-out-icon", LogOutIcon);
